...
int main(int argc, char* argv[])
{
...

  {
    ...
    io.Fonts->AddFontFromFileTTF("./fonts/NotoSansMono-Regular.ttf", 24.0f, &config, io.Fonts->GetGlyphRangesGreek());
    io.Fonts->AddFontFromFileTTF("./fonts/NotoSansMono-Regular.ttf", 24.0f, &config, io.Fonts->GetGlyphRangesCyrillic());
    ...
    io.Fonts->AddFontFromFileTTF("./fonts/NotoSansMonoCJK-VF.ttf.ttc", 24.0f, &config, io.Fonts->GetGlyphRangesThai());
    io.Fonts->Build();
